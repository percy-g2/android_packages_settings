...
public class UserDictionarySettings extends ListFragment {
    ...
    private static String mNewLocale = null;

    public static void localeChanged(String locale) {
        mNewLocale = locale;
    }

    private void updateListView(String locale) {
        mLocale = locale;
    ...
    public void onResume() {
        super.onResume();
        // If add or edit word changed locale, need to update UI.
        if (mNewLocale != null && !mNewLocale.equals(mLocale)) {
            updateListView(mNewLocale);
        }
    }
