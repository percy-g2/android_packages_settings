...
public class PrivacySettings extends SettingsPreferenceFragment implements
    ...
    public void onResume() {
        ...
        // Refresh UI
        updateToggles();
        ((com.android.settings.SubSettings)this.getActivity()).setScreenExitDialogStateON(false);
        if(((com.android.settings.SubSettings)this.getActivity()).getScreenOFFDialgDismiss()  == true){
            showEraseBackupDialog();
        }
        ((com.android.settings.SubSettings)this.getActivity()).resetScreenOFFDialgDismiss();
    }
    ...
    public void onStop() {
        if (mConfirmDialog != null && mConfirmDialog.isShowing()) {
            ...
            ((com.android.settings.SubSettings)this.getActivity()).setScreenExitDialogStateON(true);
        }else{
            ((com.android.settings.SubSettings)this.getActivity()).setScreenExitDialogStateON(false);
        }
        mConfirmDialog = null;
