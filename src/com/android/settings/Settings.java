...
public class Settings extends PreferenceActivity
    ...
    private static final String CTROAMING_PACKAGE_NAME = "com.qualcomm.CTroamingsettings";
    ...
    private boolean mScreenExitDialogStateON = false;
    private boolean mScreenOFFDialgDismiss = false;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_SCREEN_OFF.equals(action) && mScreenExitDialogStateON) {
                mScreenOFFDialgDismiss = true;
                return ;
            }
            mScreenOFFDialgDismiss = false;
        }
    };

    public boolean getScreenOFFDialgDismiss(){
        return mScreenOFFDialgDismiss;
    }

    public void resetScreenOFFDialgDismiss(){
        mScreenOFFDialgDismiss = false;
    }

    public void setScreenExitDialogStateON(boolean state){
         mScreenExitDialogStateON = state;
    }

    @Override
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        // Listen for broadcasts related to ACTION_SCREEN_OFF
    ...
    public Intent onBuildStartFragmentIntent(String fragmentName, Bundle args,
        ...
        // Fragment need to use own properties in AndroidManifest.
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            if (id == R.id.dock_settings) {
            ...
            } else if (id == R.id.multi_sim_settings_qrd) {
                ...
                boolean exist = false;
                try {
                    PackageInfo info = pm.getPackageInfo(CTROAMING_PACKAGE_NAME, PackageManager.GET_ACTIVITIES);
                    if (info != null) {
                        exist = true;
                    }
                } catch (NameNotFoundException ex) {
                    // do nothing, the application couldn't be found.
                }
                if (!exist) {
                    target.remove(header);
                }
