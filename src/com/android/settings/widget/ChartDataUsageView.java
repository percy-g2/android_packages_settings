...
public class ChartDataUsageView extends ChartView {
    ...
    private static ChartSweepView mSweepmWarningStatic;
    private static NetworkPolicy chartUsagePolicy;
    private static boolean IsSweepDone = true;
    ...
    protected void onFinishInflate() {
        ...
        mSweepmWarningStatic = mSweepWarning;
    ...
    private OnSweepListener mHorizListener = new OnSweepListener() {
        ...
        public void onSweep(ChartSweepView sweep, boolean sweepDone) {
            ...
            if (config.orientation != ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE
                ...
                config.orientation = width < height ? ActivityInfo.SCREEN_ORIENTATION_PORTRAIT
    ...
    public static class DataAxis implements ChartAxis {
        ...
        public long buildLabel(Resources res, SpannableStringBuilder builder, long value) {
            ...
            if (IsSweepDone) {
                ...
                } else if ((mSweepmLimiStatic.getValue() > 0) && (mSweepmLimiStatic.getValue() < (INPUT_MAX_VALUE * MB_IN_BYTES))
                        && (TextUtils.indexOf(builder, "/")) > -1) {
                    setText(builder, sSpace, "\n", "/");
                } else if (mSweepmWarningStatic.getValue() == (INPUT_MAX_VALUE * MB_IN_BYTES)
                        && chartUsagePolicy.limitBytes != NetworkPolicy.LIMIT_DISABLED) {
                    mSweepmWarningStatic.setValue((INPUT_MAX_VALUE * MB_IN_BYTES)
                            - (2837 * GB_IN_BYTES));
                }
            }
