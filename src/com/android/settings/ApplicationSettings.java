...
public class ApplicationSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_MOUNT_INTERNAL_SD_APP_INSTALL_LOCATION = "mount_internal_sd_app_install_location";
    private static final String KEY_MOUNT_EXTERNAL_SD_APP_INSTALL_LOCATION = "mount_external_sd_app_install_location";
...
//        getPreferenceScreen().removePreference(mToggleAdvancedSettings);
        ...
        if ("1".equals(storageValue)) {
            ...
            mInstallLocation = (ListPreference) findPreference(KEY_MOUNT_INTERNAL_SD_APP_INSTALL_LOCATION);
        }
        else {
            addPreferencesFromResource(R.xml.application_settings1);
            mInstallLocation = (ListPreference) findPreference(KEY_MOUNT_EXTERNAL_SD_APP_INSTALL_LOCATION);
        }
