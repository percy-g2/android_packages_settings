...
public class Status extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        try {
            Context otherAppContext = createPackageContext("com.android.settings", Context.CONTEXT_IGNORE_SECURITY);  
            SharedPreferences testinfo = otherAppContext.getSharedPreferences("sn_from_nv",  Context.MODE_WORLD_READABLE); 
            serial = testinfo.getString("sn_from_nv", serial);
