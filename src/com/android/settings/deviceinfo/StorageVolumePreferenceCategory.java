...
//        if (!isPrimary) mAllowFormat = false;
        ...
        if ("1".equals(storageValue)) {
            mUSBStorage = mStorageVolume == null ? false : ("/storage/sdcard0").equals(mStorageVolume.getPath());
        }
        else {
            mUSBStorage = mStorageVolume == null ? false : ("/storage/sdcard1").equals(mStorageVolume.getPath());
        }
    ...
    private void resetPreferences() {
        ...
        // It is necessary add the storagelow preference only on the INTERNAL STORAGE.
        if (mStorageLow != null && mStorageVolume == null) {
