...
public class IccLockSettings extends PreferenceActivity
    ...
    private static final String ERROR_MSG_ICC_CARD_ABSENT = "ICC card is absent.";
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_SIM_STATE_CHANGED:
                    updatePreferences();
                    break;
                 // if AIRPLANE_MODE enabled,mpindialog need not to show
                case MSG_AIRPLANE_MODE_CHANGED:
                    if (mAirplaneMode) {
                        mPinDialog.nonshowPinDialog();
                        break;
                    }
            }
    ...
    private final BroadcastReceiver mSimStateReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            // add the ACTION_AIRPLANE_MODE_CHANGED to intentfilter
    ...
    protected void onResume() {
        ...
        // ACTION_AIRPLANE_MODE_CHANGED,get the airplane state to check the mPinDialog if need to show
    ...
    private void handleException(Throwable exception, int requestType) {
        if (exception instanceof CommandException) {
            ...
            if (ERROR_MSG_ICC_CARD_ABSENT.equals(exception.getMessage())) {
                Toast.makeText(this, mRes.getString(R.string.icc_card_absent),
