...
public class MediaFormat extends Activity {
    ...
    private void establishFinalConfirmationState() {
        if (mFinalView == null) {
            ...
            if ("1".equals(storageValue) && ("/storage/sdcard0").equals(mStorageVolume.getPath()) ||
                "0".equals(storageValue) && ("/storage/sdcard1").equals(mStorageVolume.getPath())) {
                ...
                mFinalTextView = (TextView) mFinalView.findViewById(R.id.text_media_format_final);
                mFinalTextView.setText(R.string.media_format_final_desc);
            }
        }
    ...
    private void establishInitialState() {
        ...
        if (mInitialView == null) {
            ...
            if ("1".equals(storageValue) && ("/storage/sdcard0").equals(mStorageVolume.getPath()) ||
                ...
                setTitle(R.string.media_format_title);
                mFormatTextView = (TextView) mInitialView.findViewById(R.id.text_media_format);
                mFormatTextView.setText(R.string.media_format_desc);
