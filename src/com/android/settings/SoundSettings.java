...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_VIBRATE_CALL_CONNETC = "call_connect_vibrate";
    private static final String KEY_FLIP_MUTE_CALLS = "flip_mute_calls";
    private static final String KEY_FLIP_MUTE_ALARM = "flip_mute_alarm";
    ...
    private CheckBoxPreference mVibrateWhenConnect;
    private CheckBoxPreference mFlipMuteCalls;
    private CheckBoxPreference mFlipMuteAlarm;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mVibrateWhenConnect = (CheckBoxPreference) findPreference(KEY_VIBRATE_CALL_CONNETC);
        mVibrateWhenConnect.setPersistent(false);
        mVibrateWhenConnect.setChecked(Settings.System.getInt(resolver,
                     Settings.System.VIBRATE_CALL_CONNETC, 0) != 0);
        ...
        mFlipMuteCalls = (CheckBoxPreference) findPreference(KEY_FLIP_MUTE_CALLS);
        mFlipMuteCalls.setPersistent(false);
        mFlipMuteCalls.setChecked(Settings.System.getInt(resolver,
                Settings.System.FLIP_MUTE_CALLS, 1) != 0);

        mFlipMuteAlarm = (CheckBoxPreference) findPreference(KEY_FLIP_MUTE_ALARM);
        mFlipMuteAlarm.setPersistent(false);
        mFlipMuteAlarm.setChecked(Settings.System.getInt(resolver,
                Settings.System.FLIP_MUTE_ALARM, 1) != 0);
        ...
        if (vibrator == null || !vibrator.hasVibrator()) {
            ...
            getPreferenceScreen().removePreference(mVibrateWhenConnect);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference == mVibrateWhenConnect) {
            Settings.System.putInt(getContentResolver(), Settings.System.VIBRATE_CALL_CONNETC,
                        mVibrateWhenConnect.isChecked() ? 1 : 0);
        ...
        } else if (preference == mFlipMuteCalls) {
            Settings.System.putInt(getContentResolver(), Settings.System.FLIP_MUTE_CALLS,
                    mFlipMuteCalls.isChecked() ? 1 : 0);

        } else if (preference == mFlipMuteAlarm) {
            Settings.System.putInt(getContentResolver(), Settings.System.FLIP_MUTE_ALARM,
                    mFlipMuteAlarm.isChecked() ? 1 : 0);
