...
public class ApplicationsState {
   ...
   /*
    * Release resource when ManageApplication onDestroy.
    */
    public void release(){
        ...
        for (int i = 0; i < mRebuildingSessions.size(); i++) {
            Session s = mRebuildingSessions.get(i);
            s.release();
        }
        for (int i = 0; i < mActiveSessions.size(); i++) {
            Session s = mActiveSessions.get(i);
            s.release();
        }
