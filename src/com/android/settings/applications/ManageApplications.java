...
public class ManageApplications extends Fragment implements
        ...
        public View build(LayoutInflater inflater, ViewGroup contentParent, View contentChild) {
            ...
            if (mListContainer != null) {
                ...
                if ("1".equals(storageValue)) {
                    ...
                    descriptionId = R.string.sd_card_storage;
                }
            ...
            if (mFilter == FILTER_APPS_SDCARD) {
                ...
                if (mApplications != null) {
                    ...
                    for (int i=0; i<N; i++) {
                        ...
                        mAppStorage += ae.externalCodeSize + ae.externalDataSize + ae.cacheSize;
                    }
                }
            } else {
                if (mContainerService != null) {
                ...
                if (mApplications != null) {
                    ...
                    for (int i=0; i<N; i++) {
                        ApplicationsState.AppEntry ae = mApplications.getAppEntry(i);
                        mAppStorage += ae.codeSize + ae.dataSize + ae.cacheSize;
                        if (emulatedStorage) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("1".equals(storageValue)) {
            ...
            descriptionId = R.string.filter_apps_onsdcard;
        }

        if (!Environment.isExternalStorageEmulated()) {
            tab = new TabInfo(this, mApplicationsState,
                    getActivity().getString(descriptionId),
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        // Release instance, receiver and looper in mApplicationsState,
        // avoid leading memory leak.
        mApplicationsState.release();
