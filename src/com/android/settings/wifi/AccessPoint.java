...
/* Add 20120823 TS-FMC-V2 start */
    private String mFmcSummary = null;
...
/* Add 20120823 TS-FMC-V2 start */
        ...
        // Sort by priority.
        int comparison = (int) (other.getPriority() - getPriority());
        if (comparison != 0) {
            return comparison;
        }
        }
...
/* Add 20120823 TS-FMC-V2 start */
        if (FeatureQuery.FEATURE_CT_FMC_SUPPORT) {
        if (mShowFmcSummary && mFmcSummary != null) {
            setSummary(mFmcSummary);
        }
        }
/* Add 20120823 TS-FMC-V2 end */
    }
...
/* Add 20120823 TS-FMC-V2 start */
    public void setShowFmcSummary(boolean summary) {
        mShowFmcSummary = summary;
    }
    public void setFmcSummary(String summary) {
        mFmcSummary = summary;
        refresh();
    }
