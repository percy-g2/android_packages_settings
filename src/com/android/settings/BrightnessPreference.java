...
public class BrightnessPreference extends SeekBarDialogPreference implements
    ...
    private void setBrightness(int brightness, boolean write) {
        ...
        // After click the positive button of the dialog, it should save brightness value,
        // even current mode is automatic(save brightness value with same rules in two modes).
        if (write) {
            final ContentResolver resolver = getContext().getContentResolver();
