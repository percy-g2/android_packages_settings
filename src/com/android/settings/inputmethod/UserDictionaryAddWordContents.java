...
public class UserDictionaryAddWordContents {
    ...
    /* package */ void apply(final Context context) {
        ...
        if (mMode == MODE_INSERT) {
            Toast.makeText(context, R.string.user_dict_settings_toast_success, Toast.LENGTH_SHORT).show();
        }
    }
