...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    private VoiceInputOutputSettings voiceInputOutputSettings;
    ...
    public void onCreate(Bundle icicle) {
        ...
        voiceInputOutputSettings = new VoiceInputOutputSettings(this);
        voiceInputOutputSettings.onCreate();
    ...
    private void updateUserDictionaryPreference(Preference userDictionaryPreference) {
        ...
        } else if (localeList.size() == 1 && defaultLocale.equals((String)localeList.toArray()[0])) {
            final Intent intent =
                    new Intent(UserDictionaryList.USER_DICTIONARY_SETTINGS_INTENT_ACTION);
            userDictionaryPreference.setTitle(R.string.user_dict_single_settings_title);
            userDictionaryPreference.setIntent(intent);
    ...
    public void onResume() {
        ...
        if (!mIsOnlyImeSettings) {
            if (mLanguagePref != null) {
                ...
                if (localeString.length() > 1) {
                    ...
                    //Chinese(China)/Chinese(TaiWan) is unreasonable. So change them to Chinese(complex)/Chinese(simplified)
                    if(conf.locale.equals(conf.locale.SIMPLIFIED_CHINESE) || conf.locale.equals(conf.locale.TAIWAN)) {
        ...
        // Check whether need to show TTS settings.
        voiceInputOutputSettings.onResume();
    }
    ...
    public void onDestroy() {
        ...
        // Remove SettingsObserver in order to release the quote to
        // Activity  SubSetting, and avoid the memory leak.
